 ...
 *
 */
function VerifySequenceOfBST(sequence, length) {
...
function VerifySequenceOfBST2(sequence) {
    var result = false;
    if ((sequence === null || sequence === void 0 ? void 0 : sequence.length) > 0) {
        result = VerifySequenceOfBSTCore(sequence, 0, sequence.length - 1);
    }
    return result;
}
function VerifySequenceOfBSTCore(sequence, start, end) {
    if (start > end) {
        return true;
    }
    var middle = start;
